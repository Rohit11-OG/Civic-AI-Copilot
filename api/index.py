...
GROQ_API_KEY = NVIDIA_API_KEY  # back-compat for health endpoint
if NVIDIA_API_KEY:
    client = OpenAI(base_url="https://integrate.api.nvidia.com/v1", api_key=NVIDIA_API_KEY)
else:
    client = None
    print("WARNING: NVIDIA_API_KEY not set. AI features will not work.")
...
@app.route('/api/analyze/legal', methods=['POST'])
def analyze_legal():
